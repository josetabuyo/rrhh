...
BuscadorDeLegajos.prototype.buscar = function () {
    ...
    this.o.servicioDeLegajos.buscarLegajosParaDigitalizacion(this.input_numero.val(), //numero_legajo
                                       function (respuesta) {
                                           if (respuesta.legajos.length > 1) {
                                               var selector = new SelectorDeLegajos({
                                                   legajos: respuesta.legajos,
                                                   onLegajoSeleccionado: function (legajo) {
                                                       _this.o.onLegajoEncontrado(legajo);
                                                       _this.ocultarBarraDeEspera();
                                                       _this.o.ui.dialog("close");
                                                   }
                                               });
                                               selector.mostrarModal();
                                           } else {
                                               _this.o.onLegajoEncontrado(respuesta.legajos[0]);
                                               _this.ocultarBarraDeEspera();
                                               _this.o.ui.dialog("close");
                                           }
                                       },
