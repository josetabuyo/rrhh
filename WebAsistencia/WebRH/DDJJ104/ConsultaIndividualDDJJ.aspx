...
<head id="Head1" runat="server">
    ...
    <link href="../Reportes/Reportes.css" rel="stylesheet" type="text/css" />
    <link href="../Reportes/timeline.css" rel="stylesheet" type="text/css" />
                    ...
                    <fieldset>
                        ...
                        <div>
                            <p class="bloque_consulta">
                                ...
                                <span id="legajo_consulta"></span>
                            </p>
                            <p class="bloque_consulta">
                                <label>
                                    Documento:
                                </label>
                                <span id="documento_consulta"></span>
                            </p>
                        </div>
                        <div>
                            <p class="bloque_consulta">
    ...
    <div id="plantillas">
        ...
        <div id="bloque_timeline" class="bloque_timeline cd-timeline-block">
            ...
            <div class="cd-timeline-content">
                <h2 class="titulo_hito">
                </h2>
                <p class="descripcion_hito">
                </p>
...
<script type="text/javascript" src="../Reportes/Reportes.js"></script>
