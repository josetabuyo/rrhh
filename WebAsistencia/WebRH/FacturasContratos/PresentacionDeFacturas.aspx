    ...
    <div id="contenedor_consulta_rapida" style="margin: 30px;">
        ...
        <div id="ContenedorCampos">
            ...
            <div id="divBuscadorArea">
                <uc3:BuscadorDeAreas ID="buscadorArea1" runat="server" style="display: inline-block;
                    margin: auto;" />
            </div>
            <div>
                <label id="lblFirmante">
                    Firmante</label>
                <select runat="server" title="Seleccione un mes" id="cboFirmante" enableviewstate="false"
