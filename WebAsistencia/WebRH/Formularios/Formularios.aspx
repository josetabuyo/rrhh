...
<body>
    ...
    <div id="buscador_de_personas" RequiereFuncionalidad="formularios_administracion">
        ...
        <div style="margin-left: 50px;" id="contenedor_servicios_profesionales">
            ...
            <div style="margin-left: 50px;" class="bloque_de_tareas">
                ...
                <div class="bloque">
                    ...
                    <label class="tareas_otras">
                        Detalle</label>
                    <input id="Serv_Prof_Detalle" campo="Serv_Prof_Detalle" type="text" style="flex-grow:100;" placeholder="Tarea que desempeña" />
                </div>
            </div>
        </div>
        <%--Tareas Adicionales--%>
