var AdministradorDePersonas = function () {
    ...
    columnas.push(new Columna('Detalle', { generar: function (una_persona) {
        var contenedorBtnAcciones = $('<div>');
        var botonPresente = $('<input>');
        botonPresente.attr('type', 'button');
        botonPresente.addClass('btn');
        botonPresente.addClass('btn-primary');
        botonPresente.val('Administrar');
        botonPresente.click(function () {
            $("#DNIPersona").val(una_persona.documento());
            $("#areaPersona").val(una_persona.area());
            $("#btnAdministrarPersonal").click();
        });
