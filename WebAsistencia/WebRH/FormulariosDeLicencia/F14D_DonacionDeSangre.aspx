<%@ Page Language="C#" MasterPageFile="~/FormulariosDeLicencia/MPSolicitudLicencia.master" AutoEventWireup="true" CodeFile="F14D_DonacionDeSangre.aspx.cs" Inherits="FormulariosDeLicencia_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDatos" Runat="Server">
    ...
    <table width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="Label1" runat="server" Text="Solicito a Ud. se me otorgue licencia por Donación de Sangre:"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td valign="top">
                &nbsp;&nbsp;
                <asp:Label ID="Label7" runat="server" Text="Solicito a Ud. se me justifique inasistencia correspondiente al día:"></asp:Label><asp:TextBox
                    ID="TBDesde" runat="server" Enabled="False" ToolTip="Presione el boton para seleccionar la fecha."
                    Width="100px"></asp:TextBox><asp:Button ID="BCalendarioDesde" runat="server" 
                        Text="..." OnClick="BCalendarioDesde_Click" />
                <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999"
                    CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt"
                    ForeColor="Black" Height="1px" 
                ...
                <br />
                <asp:Label ID="Label3" runat="server" Text="por haber asistido a donar sangre, de acuerdo al certificado que se adjunta."></asp:Label></td>
        ...
        <tr>
            <td style="width: 303px; height: 127px" valign="bottom">
            ...
            <td style="width: 261px; height: 127px" valign="bottom">
                <br />
                <br />
