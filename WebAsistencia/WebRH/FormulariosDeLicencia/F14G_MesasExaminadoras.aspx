<%@ Page Language="C#" MasterPageFile="~/FormulariosDeLicencia/MPSolicitudLicencia.master" AutoEventWireup="true" CodeFile="F14G_MesasExaminadoras.aspx.cs" Inherits="FormulariosDeLicencia_Default" Title="Untitled Page" %>
        ...
        <tr>
            <td valign="top">
                ...
                <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999"
                    ...
                    ForeColor="Black" Height="1px" OnSelectionChanged="Calendar1_SelectionChanged1"
                ...
                <br />
                <asp:Label ID="Label3" runat="server" Text="por conformado mesa examinadora, de acuerdo al certificado que se adjunta."></asp:Label></td>
