...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDatos" runat="Server">
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="Label1" runat="server" Font-Names="Tahoma" Font-Size="16px" Text="Autorización del Funcionario inmediato superior"
                ...
                <table width="100%" style="text-align: left;">
                    <tr>
                        <td>
                            ...
                            <asp:RadioButton ID="RBDenegada" runat="server" Text="Denegada por razones de servicio"
                                Font-Names="Tahoma" Font-Size="16px" GroupName="GN" AutoPostBack="True" OnCheckedChanged="RBDenegada_CheckedChanged" />
                        </td>
                    </tr>
                </table>
                <br />
