<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vehiculos.aspx.cs" Inherits="Vehiculos" %>
...
<head>
    ...
    <link rel="stylesheet" href="Vehiculos/css/ConsultaVehicular.css" type="text/css"/>
    <link rel="stylesheet" href="Vehiculos/css/DetalleVehiculo.css" type="text/css"/>
    <%= Referencias.Css("")%>
        ...
        $(document).ready(function () {
            Backend.start(function () {
                $("#btn_verificar").click(function () {
                    window.location = "Vehiculos/DetalleVehiculo.aspx?" + $("#txt_codigo_verificacion").val();
                });
            });
        });
    </script>   
