var PanelDetalleDePublicaciones = {
    mostrar: function (opciones) {
        ...
        this.ui.find("#contenido_modal").load("PanelDetalleDePublicaciones.htm", function () {
            ...
            _this.publicaciones_fecha.val(publicacion.FechaPublicacion);
            ...
            //Bt agregar
            _this.btn_guardar = _this.ui.find("#btn_agregar_publicacion_trabajo");
            ...
            _this.btn_guardar.click(function () {
                ...
                publicacion.FechaPublicacion = _this.publicaciones_fecha.val();
