var FichaDeclaracionJurada = {
    ...
    dibujarCV: function (curriculum) {
        ...
        if (curriculum.CvEstudios.length > 0) {
            ...
            _this.caja_antecedentes_academicos.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvDocencias.length > 0) {
            ...
            _this.caja_actividades_docentes.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvEventosAcademicos.length > 0) {
            ...
            _this.caja_eventos_academicos.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvPublicaciones.length > 0) {
            ...
            _this.caja_publicaciones.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvMatricula.length > 0) {
            ...
            _this.caja_matriculas.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvInstitucionesAcademicas.length > 0) {
            ...
            _this.caja_instituciones.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvExperienciaLaboral.length > 0) {
            ...
            _this.caja_experiencias_laborales.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
        ...
        if (curriculum.CvIdiomas.length > 0 || curriculum.CvCompetenciasInformaticas.length > 0 || curriculum.CvCapacidadesPersonales.length > 0) {
            ...
            _this.caja_otras_aptitudes.addClass('antec-academ posicion degrade_modulo sombra_y_redondeado');
