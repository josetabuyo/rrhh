        ...
        <br />
            <div class="preguntas_frecuentes">
                <div style="font-size:2.2em;" class="titulo_postulaciones">Preguntas Frecuentes</div>
        	        <p style="text-align: left;"><a name="faq_1" class="disparador" href="javascript:slideonlyone('faq_1');" ><strong>1) ¿Cuándo comienza la inscripción?</strong></a></p>
                    ...
                    <p style="text-align: left;"><strong>2) ¿Quiénes se pueden presentar a la convocatoria?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>3) ¿Qué es el SINEP?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>4) ¿Me puedo postular a más de un cargo?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>5) ¿Puedo concursar si trabajo en otro sector de la Administración Pública?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>6) ¿Dónde se realiza la inscripción?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>8) ¿Cómo verifico si completé la preinscripción?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>9) ¿Cómo puedo autorizar a un apoderado para que realice la inscripción documental en mi nombre?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>10) ¿Qué debo presentar el día de la inscripción documental?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>11) ¿Qué pasa si alguno de los títulos que declaro aún está en trámite?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>12) ¿Qué pasa si no tengo toda la documentación que me solicitan al inscribirme?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>13) ¿Cómo y cuándo me entero si fui admitido?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>14) ¿Cómo se desarrolla el proceso de concurso?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>&nbsp;15) ¿Cómo puedo saber cuáles serán los contenidos que se evaluarán en las etapas del concurso?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>16) ¿Cómo se decide quién gana el concurso?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>17) ¿Existe alguna consideración particular para las personas discapacitadas?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>18) ¿Si quedé seleccionado, cuándo empiezo a trabajar?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>19) ¿Cuál es la remuneración?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>20) ¿Cuál es la carga horaria del puesto de trabajo?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>21) ¿Cuál es el lugar de trabajo?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>22) ¿Hay alguna edad límite de ingreso?</strong></p>
                    <p style="text-align: left;">Sólo la prevista para acceder a la jubilación.</p>
                    <p style="text-align: left;">&nbsp;&nbsp;</p>

                    <p style="text-align: left;"><strong>23) ¿Durante cuánto tiempo estaré contratado si soy seleccionado?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>24) ¿Qué pasa si soy extranjero?</strong></p>
                    ...
                    <p style="text-align: left;"><strong>25) ¿Qué significa que los datos tienen carácter de declaración jurada?</strong></p>
 ...
 <%= Referencias.Javascript("../") %>
    <script type="text/javascript">
       ...
       function slideonlyone(thechosenone) {
           $('.texto_escondido').click(function (index) {
               if ($(this).attr("id") == thechosenone && $(this).attr("class") == "texto_escondido") {
                   //$(this).slideDown(200);
                   $(this).toggleClass("texto_visible");
                   //$(this).attr("class", "texto_visible"); 
               }
               else {
                   $(this).toggleClass("texto_escondido");
                   //$(this).slideUp(600);
               }
           });
       }
