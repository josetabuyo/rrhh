            ...
            <div>
                <div class="grupo_campos nueva_linea">
                    <div class="grupo_campos">
                        ...
                        <input type="text" id="id_comite" style="width: 50px;" data-validar="esNumeroNatural" onblur="visualizacionDeBuscarComite()" />
                    </div>
                    <div class="grupo_campos">
                    ...
                    <div class="grupo_campos">
                        <input type="button" id="btn_buscar_postulaciones" value="Buscar" class="btn" disabled="disabled" onclick="buscarComite()" />
                    </div>
                </div>
