var CvDatosPersonales = {
    completarDatos: function (datos_personales) {
        ...
        _this.txt_domicilio_personal_piso.val(parse(datos_personales.DomicilioPersonal.Piso));
        ...
        _this.txt_domicilio_legal_piso.val(parse(datos_personales.DomicilioLegal.Piso));
