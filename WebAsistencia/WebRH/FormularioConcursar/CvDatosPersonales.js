var CvDatosPersonales = {
    completarDatos: function (datos_personales) {
        ...
        _this.cmb_estadoCivil.itemSeleccionado(datos_personales.EstadoCivil);
        _this.cmb_nacionalidad.itemSeleccionado(datos_personales.Nacionalidad);
        _this.cmb_tipoDocumento.itemSeleccionado(datos_personales.TipoDocumento);
