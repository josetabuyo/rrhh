...
/// </summary>
public class ComisionToRowSerializer : EntityToRowConverter<ComisionDeServicio>
{
    ...
    public override List<object> Serialize(ComisionDeServicio comision)
    {
        ...
        return new List<object>() {  html_ckb(comision), 
            ...
            "$ " + String.Format("{0:0.00}",(comision.Estadias[0].Eventuales + comision.Estadias[0].CalculadoPorCategoria + comision.Estadias[0].AdicionalParaPasajes)),
            MostrarDiasFaltantes(dias_faltantes),
