<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Capacitaciones.aspx.cs" Inherits="ModuloCapacitacion_Capacitaciones" %>
            ...
            <div class="caja_der papel">
                ...
                <div class="cajaPermisos">
                 ...
                 <div id="caja_documentos_cargados" style="display:none;">
                    <legend style="margin-top: 20px;">Tablero de comando</legend>
    ...
    $(document).ready(function ($) {
        ...
        Backend.start(function () {
            ...
            $(".caja_izq").load("SeccionIzquierda.htm", function () {
                ...
                Capacitaciones.iniciarConsultaRapida();
