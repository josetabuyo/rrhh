...
RepositorioDePersonas.prototype.buscarPersonasConUsuarioWeb = function (criterio, onSuccess, onError) {
    this.proveedor_ajax.postearAUrl({ url: "BuscarPersonasConUsuarioWeb",
        data: {
            criterio: criterio
        },
        success: function (personas_json) {
