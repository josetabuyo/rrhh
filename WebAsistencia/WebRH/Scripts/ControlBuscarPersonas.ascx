<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlBuscarPersonas.ascx.cs" Inherits="Scripts_ControlBuscarPersonas" %>
...
<div id="buscador_de_personas" style="border: thin solid #0000FF">
