var VistaImagen = function (opt) {
    this.o = opt;
    this.start();
};

VistaImagen.prototype.start = function () {
    this.id = this.o.idImagen;

    this.ui = $.load("#plantilla_ui_imagen").clone();
...
VistaImagen.prototype.dibujarEn = function (panel) {
    panel.append(this.ui);
};

VistaImagen.prototype.borrar = function () {
    this.ui.remove();
};