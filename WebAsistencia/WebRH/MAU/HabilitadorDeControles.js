$(document).ready(function () {
    ...
    $('[RequiereFuncionalidad]').each(function (index, control) {
        ...
        if (!parseInt($(control).attr('RequiereFuncionalidad'))) {
            Backend.ElUsuarioLogueadoTienePermisosParaElCodigoDeFuncionalidad($(control).attr('RequiereFuncionalidad'))
                .onSuccess(function (tiene_funcionalidad) {
