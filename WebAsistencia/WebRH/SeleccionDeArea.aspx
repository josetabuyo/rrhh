...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True"></asp:ScriptManager>
    ...
    <div class="contenedor_principal contenedor_principal_seleccion_areas">
        ...
        <div id="titulo_areas_a_administrar" style="text-shadow: 2px 2px 5px rgba(150, 150, 150, 1);">
            Áreas a Administrar                 
            <%--<a id="btn_consultar_consulta_ddjj" RequiereFuncionalidad="ddjj104_mostrar_todas_las_areas" class="acomodar_botones_del_menu btn btn-primary" href="DDJJ104/ConsultaIndividualDDJJ.aspx">Consultas DDJJ 104/2001</a>
            <a id="btn_consultar_areas_ddjj" RequiereFuncionalidad="ingreso_a_ddjj104" class="acomodar_botones_del_menu btn btn-primary" href="DDJJ104/FAreasConDDJJ.aspx">DDJJ 104/2001</a>--%>

            <a id="btn_seleccion_contratos" RequiereFuncionalidad="ingreso_seleccion_contrato" class="acomodar_botones_del_menu btn btn-primary" href="Contratos/SeleccionDeContratos.aspx">Selección de Contratos</a>
            <a id="btn_analisis_licencia" RequiereFuncionalidad="analisis_licencia" class="acomodar_botones_del_menu btn btn-primary" href="FormulariosDeLicencia/CalculoDeLicenciaOrdinaria.aspx">Analisis Licencias</a>
