...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True"></asp:ScriptManager>
    ...
    <div class="contenedor_principal contenedor_principal_seleccion_areas">
        ...
        <div id="titulo_areas_a_administrar" style="text-shadow: 2px 2px 5px rgba(150, 150, 150, 1);">
            Áreas a Administrar                 
            <a id="btn_consultar_consulta_ddjj" RequiereFuncionalidad="23" class="btn btn-primary" href="DDJJ104/ConsultaIndividualDDJJ.aspx">Consultas DDJJ 104/2001</a>
            ...
            <a id="btn_seleccion_contratos" RequiereFuncionalidad="43" class="btn btn-primary" href="Contratos/SeleccionDeContratos.aspx">Selección de Contratos</a>
        </div>
