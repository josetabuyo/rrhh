requirejs(['../common'], function (common) {
    requirejs(['jquery', 'backend', 'proveedorAjax', 'menuDesplegable', 'vistaTipoTicket', 'vistaItemMenu', 'vistaThumbnail'], function ($, Backend, ProveedorAjax, MenuDesplegable, VistaTipoTicket, VistaItemMenu, VistaThumbnail) {
        'vistaTipoTicket', 'vistaItemMenu', 'vistaThumbnail'
