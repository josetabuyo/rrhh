<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BarraMenuInicioSACC.ascx.cs"
    Inherits="BarraMenuInicioSACC" %>
    ...
    <div id="contenedor_barraInferior">
        <div id="barra_menu_inferior">
            ...
            <div id="barra_menu_inferior_botones">
                ...
                <a id="A1" rel="leanModal" class="btn barra_menu_botones" name="signup" href="#signup">
