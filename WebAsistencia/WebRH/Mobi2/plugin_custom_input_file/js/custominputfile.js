...
FileItem.prototype = {
	init : function(){
        ...
        /*switch (app.settings.type) {
            case "image":
                fr.readAsDataURL(this.file);//leo predatos y el contenido del archivo data:image/png;base64,asdfdsfdsdddsfdsfsff....
                break;
            default:
                fr.readAsText(this.file); //leo  solo el contenido asdfdsfdsdddsfdsfsff....
                break;
        }*/
