<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportesBienes.aspx.cs" Inherits="MoBi_ReportesBienes" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="ReportesBienes.js"></script>
    <%--CONTROL ORGANIGRAMA--%>
...
<body>
    ...
    <div>
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" style="position: relative;
            ...
            <input id="showLeftPush" type="button" class="btn_organigrama" value="Organigrama" />
