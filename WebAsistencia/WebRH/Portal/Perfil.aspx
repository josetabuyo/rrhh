    ...
    <div class="container-fluid">
        ...
        <div style="margin: 0 auto;" class="row">
            ...
            <div class="caja_der papel">
                ...
                <div class="cajitas">
                    <p class="">
                        <label class="item_cajita">
                            Sector:
                        </label>
                        <span id="txt_sector"></span>
                    </p>
                    <p class="">
                        <label class="item_cajita">
                            Nivel y Grado:
                        </label>
                        <span id="txt_nivel_grado"></span>
                    </p>
                </div>
                <div class="cajitas">
                    <p>
                        ...
                        <span id="txt_planta"></span>
                    </p>
                    <p class="">
                        <label class="item_cajita">
                            Agrupamiento:
                        </label>
                        <span id="txt_agrupamiento"></span>
                    </p>
                </div>
                <div class="cajitas">
                    <p class="">
        ...
        <a href="Certificado.aspx">
            <input id="btn_nueva_consulta" type="button" style="left: 25px;" class="btn btn-primary boton_destellante"
                value="Solicitar Certificado de Antigüedad"  />
        </a>
        </div>
    </div>
    </form>
