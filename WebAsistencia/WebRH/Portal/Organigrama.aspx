...
<head runat="server">
    ...
    <script type="text/javascript" src="../Scripts/FuncionesDreamWeaver.js"></script>
        ...
        <link id="link1" rel="stylesheet" href="../Protocolo/ConsultaProtocolo.css" type="text/css" runat="server" />
        <link id="link5" rel="stylesheet" href="../Protocolo/VistaDeArea.css" type="text/css" runat="server" />
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True"></asp:ScriptManager>
            ...
            <div class="caja_der papel">
                ...
                <div style="text-align:center; margin-bottom:20px;">
                    <a  class="btn btn-primary" style="margin:2px;" href="Docs/Organigrama_vigente.pdf" download >Descargar Organigrama PDF</a>
                    <input id="btnLugares" type="button" class="btn btn-primary" style="margin:2px;" value="Lugares de trabajo" />
                    <input id="btnAutoridades" type="button" class="btn btn-primary" style="margin:2px;" value="Autoridades" />
                </div>
