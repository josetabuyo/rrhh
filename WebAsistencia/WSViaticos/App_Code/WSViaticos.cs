...
public class WSViaticos : System.Web.Services.WebService
{
    ...
    public PlanillaEvaluacionesDto GetPlanillaEvaluaciones(int id_curso)
    {
        ...
        EvaluacionDto[] EvaluacionesDto = { new EvaluacionDto(), new EvaluacionDto() };
        InstanciaEvaluacionDto[] InstanciasDto = { new InstanciaEvaluacionDto(), new InstanciaEvaluacionDto() };
