...
namespace TestViaticos
{
    ...
    public class TestRepositorioAreas
    {
        ...
        public void deberia_poder_obtener_todos_los_datos_del_area_y_ver_que_estan_completos()
        {
            ...
            string source = @"  |Id_Area	|descripcion     |direccion             |Telefono_Area      |Mail_Area                  |Nombre_Asistente	   |Apellido_Asistente	     |Cargo	        |Prioridad_Asistente	  |Telefono_Asistente	    |Fax_Asistente          |Mail_Asistente	                |Nombre_Responsable     |Apellido_Responsable	  |Telefono_Responsable	    |Fax_Responsable  	    |Mail_Responsable	                
                                |1  	    |RRHH            |9 de Julio 1925       |4333-1111          |area1@ministerio.gob.ar    |Juan                  |García                   |Secretaria    |1                        |4444-5555                |4444-1111              |juan.garcia@mds.gov.ar         |Fabián                 |Miranda                  |4567-2222                |4544-3322              |fabian.miranda@ministerio.gov.ar
                                |2	        |Dirección       |17 de Agosto 1850     |4333-2222          |area2@ministerio.gob.ar    |María                 |Pérez                    |Secretaria    |1                        |4444-5555                |4444-1111              |maria.perez@ministerio.gov.ar  |Marta                  |Novoa                    |4567-1111                |4544-1111              |marta.novoa@ministerio.gov.ar               ";
