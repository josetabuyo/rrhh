...
namespace General.Repositorios
{
    public class RepositorioDeEvaluacion
    {
        ...
        {
            GetEvaluaciones();
            return this.evaluaciones.FindAll(evaluaciones => evaluaciones.IdCurso.Equals(id_curso) && evaluaciones.IdAlumno.Equals(id_alumno));
        }

        public void GuardarEvaluaciones(Evaluacion evaluacion, Usuario usuario)
        {
            var parametros = new Dictionary<string, object>();
            parametros.Add("id_alumno", evaluacion.IdAlumno);
            parametros.Add("id_curso", evaluacion.IdCurso);
