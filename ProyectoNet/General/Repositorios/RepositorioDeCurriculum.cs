    ...
    public class RepositorioDeCurriculum : IRepositorioDeCurriculum
    {
                ...
                cv = new CurriculumVitae(
                    new CvDatosPersonales(documento, row.GetString("Nombre"), row.GetString("Apellido"), row.GetString("Sexo"), row.GetSmallintAsInt("EstadoCivil"),
                        ...
                        new CvDomicilio(row.GetString("DomLab_Calle"), row.GetInt("DomLab_Numero"), row.GetString("DomLab_Piso"), row.GetString("DomLab_Depto"),
                            row.GetString("DomLab_Localidad"), row.GetSmallintAsInt("DomLab_CodigoPostal"), row.GetSmallintAsInt("DomLab_IdProvincia")))
            ));
        ...
        public List<CvDomicilio> GetCvDomicilio(int documento)
        {
            var domicilio = new List<CvDomicilio>()
                               {
                                   new CvDomicilio("Pedro Morán", 1234, "7", "A", "Capital Federal", 1419, 2)
                               };
