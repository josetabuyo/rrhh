...
namespace General.Repositorios
{
    public class RepositorioDeCurriculum : IRepositorioDeCurriculum
    {
        ...
        public List<CvEstudios> GuardarCvAntecedentesAcademicos(CvEstudios antecedentesAcademicos_nuevo, Usuario usuario)
        {
            ...
            var estudios = conexion_bd.Ejecutar("dbo.CV_Ins_AntecedentesAcademicos", parametros);
        ...
        public List<CvCertificadoDeCapacitacion> GuardarCvCapacidades(CvCertificadoDeCapacitacion capacidades_nuevo, Usuario usuario)
        {
            ...
            var parametros = ParametrosDeCapacitaciones(capacidades_nuevo, usuario, 0);
        ...
        public CvCertificadoDeCapacitacion EliminarCvCapacidades(CvCertificadoDeCapacitacion capacidades_nuevo, Usuario usuario)
        {
            var baja = CrearBaja(usuario);

            var parametros = ParametrosDeCapacitaciones(capacidades_nuevo, usuario, baja);
        ...
        private Dictionary<string, object> ParametrosDeCapacitaciones(CvCertificadoDeCapacitacion capacidades_nuevo, Usuario usuario, int baja)
        {
            var parametros = new Dictionary<string, object>();
        ...
        public CvDocencia EliminarCvAntecedentesDocencia(CvDocencia docencia_nuevo, Usuario usuario)
        {
            var baja = CrearBaja(usuario);
        ...
        public CvPublicaciones EliminarCvPublicaciones(CvPublicaciones publicacion_nueva, Usuario usuario)
        {
            var baja = CrearBaja(usuario);
        ...
        public CvInstitucionesAcademicas EliminarCvInstituciones(CvInstitucionesAcademicas institucion_nueva, Usuario usuario)
        {
            var baja = CrearBaja(usuario);
        ...
        public CvExperienciaLaboral EliminarCvExperiencias(CvExperienciaLaboral experiencia_nueva, Usuario usuario)
        {
            var baja = CrearBaja(usuario);
        ...
        public CvIdiomas EliminarCvIdiomas(CvIdiomas idioma, Usuario usuario)
        {
            var baja = CrearBaja(usuario);
