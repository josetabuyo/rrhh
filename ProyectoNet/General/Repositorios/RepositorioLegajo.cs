            ...
            if (tablaDatos.Rows.Count > 0)
            {
                tablaDatos.Rows.ForEach(row =>
                {
                    list_experiencia_publica.Add(new
                    {
                        ...
                        Id_Contrato = row.GetInt("Id_Contrato", 0),
                        Nro_Documento = row.GetInt("Nro_Documento", 0),
                        Tipo_Contrato = row.GetInt("Tipo_Contrato", 0),
                        Descri_Tipo_Contrato = row.GetString("Descri_Tipo_Contrato", ""),
                        Apellido = row.GetString("Apellido", ""),
                        Nombre = row.GetString("Nombre", ""),
                        ApeNom = row.GetString("ApeNom", ""),
                        Desde = row.GetString("Desde", ""),
                        Hasta_Original = row.GetString("Hasta_Original", ""),
                        Hasta_Real = row.GetString("Hasta_Real", ""),
                        Nivel = row.GetString("Nivel", ""),
                        Grado = row.GetString("Grado", ""),
                        Desc_Tipo_Acto_Ap = row.GetString("Desc_Tipo_Acto_Ap", ""),
                        Acto_Nro_Ap = row.GetString("Acto_Nro_Ap", ""),
                        Acto_Fecha_Ap = row.GetString("Acto_Fecha_Ap", ""),
                        Exp_Nro = row.GetString("Exp_Nro", ""),
                        Apellido_Firm = row.GetString("Apellido_Firm", ""),
                        Nombre_Firm = row.GetString("Nombre_Firm", ""),
                        CadenaActo = row.GetString("CadenaActo", ""),
                        Baja = row.GetString("Baja", ""),
                        Fecha_Baja = row.GetString("Fecha_Baja", ""),
                        Desc_Tipo_Acto_Bj = row.GetString("Desc_Tipo_Acto_Bj", ""),
                        Acto_Nro_Baja = row.GetString("Acto_Nro_Baja", ""),
                        Acto_Fecha_Baja = row.GetString("Acto_Fecha_Baja", ""),
                        Desc_Mot_Baja = row.GetString("Desc_Mot_Baja", ""),
                        Id_RCI = row.GetInt("Id_RCI", 0),
                        Fecha_Impresion = row.GetString("Fecha_Impresion", ""),
