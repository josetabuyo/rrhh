...
namespace General.Repositorios
{
    ...
    {
        TablaDeDatos Ejecutar(string procedimiento, int segundos_timeout = 90);
        TablaDeDatos Ejecutar(string procedimiento, System.Collections.Generic.Dictionary<string, object> parametros, int segundos_timeout = 90);
