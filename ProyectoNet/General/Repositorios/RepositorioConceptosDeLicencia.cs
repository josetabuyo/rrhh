...
namespace General.Repositorios
{
    public class RepositorioConceptosDeLicencia
    {
        ...
        public List<GrupoConceptosDeLicencia> GetGruposConceptosLicencia()
        {
            ...
            //grupo.Conceptos = new List<ConceptoDeLicencia>();
            //grupo.Conceptos.Add(new ConceptoDeLicencia { Id = 0, Articulo = "101", Inciso = "VIA", Descripcion = "Viaticos", PathFormularioWeb = "~\\FormularioDeViaticos\\FCargaComisionDeServicio.aspx", DiasHabiles = false });
            //grupos.Add(grupo);
