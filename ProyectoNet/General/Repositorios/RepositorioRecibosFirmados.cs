...
namespace General.Repositorios
{
    public class RepositorioRecibosFirmados : RepositorioLazySingleton<ReciboFirmado>    
    {
        ...
        public bool agregarReciboFirmado(int idRecibo, int idArchivo, int año, int mes, int tipoLiquidacion)
        {
        ...
        protected override void QuitarDeLaBase(ReciboFirmado reciboFirmado, int id_usuario_logueado)
        {
