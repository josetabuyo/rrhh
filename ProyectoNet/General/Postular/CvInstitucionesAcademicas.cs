...
namespace General
{
    public class CvInstitucionesAcademicas
    {
        ...
        public CvInstitucionesAcademicas(int id, string institucion, string caracterEntidad, string cargosDesempeniados, string numeroAfiliado, string categoriaActual, DateTime fechaAfiliacion, DateTime fecha, DateTime fechaInicio, DateTime fechaFin, int localidad, int pais  )
        {
            this._id = id;
